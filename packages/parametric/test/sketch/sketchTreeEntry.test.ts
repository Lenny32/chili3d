...
import { type ICameraController, type INode, Plane, PubSub, Result, XYZ } from "@spicy3d/core";
import {
...
import "../../src/sketch/index"; // registers the nodeDoubleClicked subscription
