...
import { type FloatPanelOptions, type IDocument, Localize, PubSub } from "@spicy3d/core";
import { div, label, svg } from "@spicy3d/element";
...
customElements.define("spicy-float-panel", FloatPanel);
